...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/throbbing-silence-f145
```

A live public deployment of this template is available at [https://throbbing-silence-f145.templates.workers.dev](https://throbbing-silence-f145.templates.workers.dev)
